...
object SipContactHeaders {
    ...
    fun transport(socket: SipConnection): String = if (socket is SipConnectionTcp) "tcp" else "udp"

    fun sipInstanceFromImei(imei: String): String = "<urn:gsma:imei:${imei.substring(0, 8)}-${imei.substring(8, 14)}-0>"
    ...
    fun mmtelContact(
        ...
        transport: String,
        sipInstance: String,
    ): String = """<sip:$userPart@$localEndpoint;transport=$transport>;expires=7200;+sip.instance="$sipInstance";$MMTEL_CONTACT_FEATURES"""
