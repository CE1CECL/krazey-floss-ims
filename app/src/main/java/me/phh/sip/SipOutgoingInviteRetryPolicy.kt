...
internal object SipOutgoingInviteRetryPolicy {
    ...
    fun notRetryingAfter422TwiceLog(callId: String): String = "Not retrying outgoing INVITE after 422 twice callId=$callId"
    ...
    fun desiredNextCseqAfter422Retry(retryCseqNumber: Int): Int = retryCseqNumber + 1
    ...
    fun notRetryingIllegalSdpTwiceLog(callId: String): String = "Not retrying outgoing INVITE after illegal SDP twice callId=$callId"
    ...
    fun illegalSdpRetryWriteLabel(): String = "SipHandler illegal-sdp retry INVITE"
