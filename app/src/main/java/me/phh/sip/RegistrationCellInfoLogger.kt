    ...
    fun log(
        ...
        for (cell in telephonyManager.getAllCellInfo()) {
            if (cell is CellInfoLte) {
                ...
                Rlog.d(
                    logTag,
                    "LTE cell: ${cellIdentity.ci}, ${cellIdentity.pci}, ${cellIdentity.tac}, ${cellIdentity.mccString}, ${cellIdentity.mncString}, ${cellSignalStrength.dbm}",
                )
                ...
                Rlog.d(
                    logTag,
                    "WCDMA cell: ${cellIdentity.cid}, ${cellIdentity.lac}, ${cellIdentity.mccString}, ${cellIdentity.mncString}, ${cellSignalStrength.dbm}",
                )
                ...
                Rlog.d(
                    logTag,
                    "GSM cell: ${cellIdentity.cid}, ${cellIdentity.lac}, ${cellIdentity.mccString}, ${cellIdentity.mncString}, ${cellSignalStrength.dbm}",
                )
            }
        }
    }
